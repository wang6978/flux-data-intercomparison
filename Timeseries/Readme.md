...
In addition to correted latent heat flux (LE), the uncorrected LE was also included as a plotting variable. Note that LE values were converted to evapotranspiration (mm) before plotting. 
